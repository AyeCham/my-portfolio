      ...
      <div className="container hero__inner">
        <div className="hero__text">
          ...
          <div className="actions">
            ...
            <a href={`${import.meta.env.BASE_URL}docs/resume.pdf`} target="_blank" rel="noopener">View Résumé</a>
          </div>
          <p className="muted small">📍 Chiang Rai, Thailand · Open to internships & freelance</p>
        </div>

        <div className="hero__card card">
        <img src={`${import.meta.env.BASE_URL}images/portrait.jpg`} alt="portrait" />
          <ul className="tags">
